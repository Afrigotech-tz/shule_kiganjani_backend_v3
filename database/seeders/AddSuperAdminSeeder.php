...
//        ]);
        ...
        SystemSetting::upsert([
            ...
            ["name" => "facebook", "data" => "https://www.facebook.com/afrigotech.in/", "type" => "text"],
            ["name" => "instagram", "data" => "https://www.instagram.com/afrigotech.in/", "type" => "text"],
            ["name" => "linkedin", "data" => "https://in.linkedin.com/company/afrigotech", "type" => "text"],
            ["name" => "footer_text", "data" => "<p>&copy;&nbsp;<strong><a href='https://afrigotech.in/' target='_blank' rel='noopener noreferrer'>afrigotech</a></strong>. All Rights Reserved</p>", "type" => "text"],
